...
public class ChoucairAcademyStepDefinitions {
    ...
    public void thanLuisWantsToLearnAutomationAtTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData) throws Exception{
        OnStage.theActorCalled("Luis").wasAbleTo(OpenUp.thePage(), Login.
    ...
    public void heFinsTheCourseCalledResourcesAutomatizacionBancolombia(List<AcademyChoucairData> academyChoucairData)
            throws Exception{
